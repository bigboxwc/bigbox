...
<div id="bigbox-license-reminder-notice" class="notice notice-error is-dismissible">
	<p>
	<?php
		echo '<strong>' . __( 'You have not entered your BigBox license key!', 'bigbox' ) . '</strong> ' . __( 'You will not be able to automatically update your BigBox theme.', 'bigbox' ) . ' <a href="' . esc_url( add_query_arg( 'page', 'bigbox', admin_url( 'themes.php' ) ) ) . '">' . __( 'Add your license key now &rarr;', 'bigbox' ) . '</a>'; // WPCS: XSS okay.
	?>
	</p>
</div>
