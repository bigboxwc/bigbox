...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		<h2 class="woocommerce-Reviews-title"><?php esc_html_e( 'Product reviews', 'bigbox' ); ?></h2>
		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						'title_reply'          => esc_html__( 'Add a review', 'bigbox' ),
						'title_reply_to'       => __( 'Leave a Reply to %s', 'bigbox' ),
