 ...
 * @param WP_Customize_Manager $wp_customize The Customizer object.
 */
function bigbox_customize_register_type( $wp_customize ) {
	// Create "Scheme" and "Grays" sections.
	$wp_customize->add_section(
		'type', [
			'title'    => _x( 'Typography', 'customizer section title (colors)', 'bigbox' ),
			'priority' => 20,
		]
	);
	$wp_customize->add_setting(
...
add_action( 'customize_register', 'bigbox_customize_register_type', 11 );
